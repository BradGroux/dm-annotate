...
@objc protocol AppMenuActionHandling: AnyObject {
    ...
    func clearAll()
    func saveAnnotationSession()
    func loadAnnotationSession()
...
struct AppMenuBuilder {
    ...
    func statusMenu() -> NSMenu {
        ...
        menu.addItem(menuItem("Compact Presenter Mode", action: #selector(AppMenuActionHandling.toggleToolbarCompactMode), shortcut: .toggleToolbarCompactMode))
        ...
        menu.addItem(menuItem("Save Annotation Session...", action: #selector(AppMenuActionHandling.saveAnnotationSession), key: ""))
        menu.addItem(menuItem("Load Annotation Session...", action: #selector(AppMenuActionHandling.loadAnnotationSession), key: ""))
        menu.addItem(.separator())
